<?php 
    ...
    mysqli_close($databaseConnection);
        ...
        // This code was previously written to priortise only clients' risk level and product types and make clients' countries and industry preferences optional when recommending product to them. 

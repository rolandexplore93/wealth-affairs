...
// Send a POST request to getclient.php
fetch('http://localhost/your-backend/getclient.php', {
  method: 'POST',
  headers: {
...
.then(response => response.json())
.then(data => {
  // Display the list of clients on the frontend
  const clientList = data.clients;
  // do something with clientList
})
.catch(error => {
...
// Get the product information from the POST request body
$product_id = $_POST['productId'];
$risk_level = $_POST['riskLevel'];
$country = $_POST['country'];

// Query the database to get the list of clients based on the product information
// ...

// Create the response array
$response = array(
  'clients' => $clients // Array of clients retrieved from the database
);
